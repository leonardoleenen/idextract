...
export default () => {
  ...
  return (<div>
    ...
    <article className="text-gray-600 mb-4 leading-relaxed ">
      <p className="text-secondary-400  mb-2 leading-normal">
        Los presentes términos y condiciones particulares (en adelante, los “Términos y Condiciones”)
        rigen la relación entre Secretaríala Secretaría de Innovación Pública de la Jefatura de Gabinete de Ministros de la Nación (en adelante, la “Secretaría”)
        y los usuarios de la aplicación denominada Covid19-Ministerio de Salud (en adelante, los  “Usuarios”), tanto en su versión web -accesible a través de
        argentina.gob.ar/coronavirus–como en su versión para dispositivos móviles que podrá descargarse de las tiendas de aplicaciones oficiales de Android e iOS
        (en adelante, la “Aplicación”).
</p>
      <p className="text-secondary-400  mb-2 leading-normal">
        El registro del Usuario en la Aplicación implica la aceptación inmediata y sin reserva de los presentes Términos
        y Condiciones, quedando entendido que en caso de contradicción prevalecerán estos Términos y Condiciones. En consecuencia, el Usuario manifiesta haber leído y
        aceptado en su totalidad los Términos y Condiciones; dicha aceptación es indispensable para la utilización de la Aplicación.  Si no está de acuerdo con los presentes
        Términos y Condiciones rogamos no utilizar la Aplicación.
</p>

      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">1. Descripción de la Aplicación</h2>
      <p className="mb-4">
        1.1. La Aplicación es una herramienta tecnológica que brinda información sobre  diversos temas referentes a
        los síntomas y/o prevención del virus COVID- 19 con la finalidad de ayudar a prevenir la propagación del virus.
</p>
      <p className="mb-4">
        1.2.	La Aplicación también incorporará en un mapa con geo localización las unidades de salud cercanas al Usuario;
</p>
      <p className="mb-4">
      ...
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">2. Requisitos de uso de la Aplicación</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">3. Información contenida en la Aplicación</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">4. Utilización de la Aplicación</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">5. Protección de Datos Personales</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">8. Modificaciones de la Aplicación</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">9. Propiedad Intelectual</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        9.2.	La Secretaría se reserva todos los derechos sobre la Aplicación y el contenido de la Aplicación, no cede ni transfiere a favor del Usuario ningún derecho sobre su propiedad intelectual.
</p>
      <p className="mb-4">
        9.3.	Los derechos de propiedad intelectual respecto de los criterios de selección y/o disposición del contenido en la Aplicación corresponden exclusivamente a la Secretaría, quedando estrictamente prohibido al Usuario utilizar los contenidos, las categorías y/o cualquier información de  la Aplicación con otra finalidad distinta a la indicada en los presentes Términos y Condiciones.
</p>
      <p className="mb-4">
        9.4.	En el caso de que la Aplicación permita descargar contenido para su posterior lectura por el Usuario, la Secretaría otorga al Usuario una licencia de uso gratuita, no transferible, no exclusiva y para uso estrictamente personal.
</p>
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">10. Operatividad de la Aplicación</h2>
      <p className="mb-4">
        10.1.	La Secretaría no garantiza el pleno acceso y operatividad de la Aplicación en forma ininterrumpida.
</p>
      <p className="mb-4">
        10.2.	La Secretaría podrá suspender el acceso a la Aplicación y/o a determinado contenido por motivos de mantenimiento o de seguridad en cualquier momento.
</p>
      <h2 className="text-lg  text-secondary-500  font-bold mb-4 mt-4 pt-4 ">11. Notificaciones y comunicaciones</h2>
      <p className="mb-4">
        11.1 Las notificaciones y comunicaciones cursadas por la Secretaría a la casilla de correo electrónico que haya provisto el Usuario al momento del registro se considerarán eficaces y plenamente válidas. Asimismo, se considerarán eficaces las comunicaciones que consistan en avisos y mensajes insertos en la Aplicación que tengan por finalidad informar al Usuario sobre determinada circunstancia, como por ejemplo, un cambio en éstos términos y condiciones o en la política de privacidad.
</p>
      <h2 className="text-lg  text-secondary-500 font-bold mb-4 mt-4 pt-4 ">12. Legislación aplicable y jurisdicción</h2>
      <p className="mb-4">
        12.1.	A todos los efectos legales en relación a la Aplicación, será aplicable la legislación vigente en la República Argentina.
</p>
      <p className="mb-4">
        12.2.	Cualquier controversia que se suscite entre las partes con relación a estos Términos y Condiciones, su existencia, validez, calificación, interpretación, alcance, cumplimiento o resolución, se resolverá definitiva y exclusivamente por los Tribunales Nacionales en lo Contencioso Administrativo Federal.
</p>
    </article>
  </div>)
}
